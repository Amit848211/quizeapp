...
function Data() {
  ...
  return (
    <div className="quiz-container w-[80%] h-[80%] flex justify-center ">
      
      <div >
      <div className="flex gap-4">
        <h2 className="text-black">Question {currentQuestionIndex + 1}:</h2>
        <p className="text-white h-auto text-2xl">{currentQuestion.question}</p>
        </div>
        <ul className="text-orange-500 pl-[15%] mt-4 text-2xl">
        ...
        <p className="text-white rounded-2xl bg-green-500 w-48 flex justify-center mt-4">Time left: {timer} seconds</p>
        <button  className="text-white rounded-2xl bg-green-500 w-48 flex justify-center mt-4" onClick={handleSkipQuestion}>Skip Question</button>
      </div>
    </div>
  );
}
